...
<form method="POST" action="includes/create_product.php" enctype="multipart/form-data">
            <!-- pbrand -->
           ...
           onclick="toggleDropdown()" required>
            ...
            <a href="index.php?form=create_form_product&page=upload_products&link=admin_link"><button type="submit" class="btn btn-warning">Véglegesítés</button></a>
            </div>
</form>
